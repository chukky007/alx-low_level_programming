 ...
 * @new_size: the new size, in bytess, of the new memory block
 *
 * Return: If the new_size is equal to the old_size, do nothing and return ptr. If
 * new_size is equal to zero and ptr is NULL, call free(ptr) and return
